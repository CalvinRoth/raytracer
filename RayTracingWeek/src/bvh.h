...
bool bvh_node::hit(const ray& r, double t_min, double t_max, hit_record& rec) const {
    ...
    // This is neccesary because there could be a closer sphere in the right branch even if there
    // were a hit in the left branch
...
bool bvh_node::bounding_box(double t0, double t1, aaab& output_box) const {
    output_box = box;
    return true;
}
